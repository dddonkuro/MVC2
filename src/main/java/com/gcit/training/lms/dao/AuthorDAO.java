...
public class AuthorDAO extends AbstractDAO implements ResultSetExtractor<List<Author>>
{
	...
	public int authorCount(Author a) throws SQLException
	{
		return template.queryForObject("select count(*) from tbl_author where authorId = ?", new Object[] { a.getAuthorId() },Integer.class);
